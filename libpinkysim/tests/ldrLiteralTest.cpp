...
TEST(ldrLiteral, LoadOffset0IntoHighestRegister)
{
    ...
    SimpleMemory_SetMemory(m_context.pMemory, m_context.pc + 4, 0xBAADFEED, READ_ONLY);
...
TEST(ldrLiteral, LoadMaximumOffsetIntoLowestRegister)
{
    ...
    SimpleMemory_SetMemory(m_context.pMemory, m_context.pc + 4 + 255*4, 0xBAADFEED, READ_ONLY);
